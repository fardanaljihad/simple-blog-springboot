...
public class CommentController {
	...
	public Object deteleComment(HttpServletResponse response, @RequestParam("id") Long id) {
	...
	public List<Comment> searchByComment(@RequestParam("post_id") Long postId, @RequestParam("query") String query) {
		List<Comment> comments = commentService.searchCommentByComment(postId, query);
		return comments;
	}
