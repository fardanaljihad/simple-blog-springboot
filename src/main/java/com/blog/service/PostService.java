...
public class PostService {
	...
	public List<Post> searchPostByTitle(String query) {
		List<Post> posts = postJpaRepository.findAllByTitleContainingOrderByUpdtDateDesc(query);
		return posts;
	}
	
	public List<Post> searchPostByContent(String query) {
		List<Post> posts = postJpaRepository.findAllByContentContainingOrderByUpdtDateDesc(query);
		return posts;
	}
